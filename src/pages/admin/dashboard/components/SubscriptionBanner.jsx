...
export default function SubscriptionBanner({
  ...
  return (
    <section className="relative flex w-full overflow-hidden rounded-lg border border-[#ebe5db] bg-[#F7F5F1] px-6 py-8 shadow-sm sm:px-8 sm:py-10 lg:px-12 lg:py-12">
      ...
      */}
      ...
      <div className="relative z-10 w-full max-w-2xl lg:w-[60%]">
        <div className="inline-flex items-center gap-1.5 rounded-full bg-[#B6C5B1] px-3.5 py-1.5 text-xs font-medium text-white shadow-sm">
