  ...
  return (
    <section className='w-full  text-[#171717] font-playfair'>
      <header className='mb-6'>
        <h1 className='m-0 text-3xl leading-tight text-[#1b1b1b] md:text-4xl'>Profile</h1>
        <p className='mt-2 text-sm text-[#7a7a7a]'>Manage your wedding details and personal information</p>
      </header>
