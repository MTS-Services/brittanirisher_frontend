    ...
    <div className="overflow-hidden bg-[#f4f0ea] text-[#2d2d2d]">
      <section className="relative h-150 overflow-hidden">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute right-0 top-40 hidden w-56 opacity-90 lg:block"
        />
      </section>
      ...
      <section className="relative overflow-hidden bg-[#d7dfd6] px-4 py-20 sm:px-6 lg:px-48 lg:py-20">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute right-0 bottom-0 hidden w-64 opacity-75 lg:block"
        />

        <div style={{ maxWidth: 1536 }} className="mx-auto text-center">
          <img
            src={FLOWER_LEFT}
            alt=""
            aria-hidden="true"
            className="mx-auto w-44 opacity-90"
          />
          ...
          >
            {FAQ_ITEMS.map(item => (
              <details
                key={item.title}
                open={item.open}
                className="group border-0 bg-[#f0e9e1] px-5 space-y-4 py-4 rounded-sm"
              >
                ...
                {item.body && (
                  <p className="mt-4 font-raleway text-[14px] leading-6 text-[#615d58]">
                    {item.body}
                  </p>
                )}
              </details>
