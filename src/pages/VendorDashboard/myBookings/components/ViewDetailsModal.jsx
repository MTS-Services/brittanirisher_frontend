...
const ViewDetailsModal = ({ booking, onClose, isLoading }) => {
          ...
          <div className='flex items-start justify-between px-6 pb-4 pt-5'>
            <div className='flex items-start gap-4'>
              <div className='relative'>
                <div className='flex h-20.5 w-20.5 items-center justify-center rounded-full border-[3px] border-[#cfd6ea] bg-[#b8b3b3] text-[22px] text-[#4a2e35]'>
                  {booking.initials}
                </div>
              ...
              <div>
                <h2 className='font-playfair text-2xl leading-none text-[#17305d]'>
                  {booking.name}
                </h2>
            ...
            <button
              ...
              onClick={onClose}
              className='border-none bg-transparent p-0 text-[#111] outline-none ring-0 focus:outline-none focus:ring-0'
            >
              <X size={28} />
            </button>
          </div>
          ...
          <div className='mx-4 mb-6'>
            <div className='rounded-xl border border-[#cfd6ea] p-4'>
              ...
              <div className='mt-4 rounded-[10px] bg-[#f7f3ea] px-4 py-4'>
                ...
                <p className='mt-1 text-[20px] text-[#2f2f2f]'>
                  {booking.venue}
                </p>
              </div>
