  ...
  return (
    ...
    <div className="mb-3 flex items-center justify-between">
      ...
      <button
        ...
        className='rounded-lg bg-[#B9C7B8] px-3 py-2 text-sm font-normal text-white shadow-sm'
      >
        + Add Price
      </button>
      </h2>
      <button className="rounded-lg shadow-sm bg-[#B9C7B8] px-3 py-2 text-sm text-white font-normal">
        + Add Price
      </button>
    </div>
        ...
        >
          ...
          >
            <div className='flex items-center justify-between border-b border-[#dfdfdf] px-5 py-4'>
              <h3 className='font-playfair text-[38px] leading-none text-[#3e3e3e] sm:text-[40px]'>
                New Subscription
              </h3>
              <button
                type='button'
            ...
            <form className='space-y-4 px-5 py-4'>
              <div>
                <label htmlFor='subscriptionTitle' className='mb-1.5 block text-[28px] leading-none text-[#333333]'>
                  Subscription Tittle
                </label>
                <input
              ...
              <div>
                <label htmlFor='subscriptionDescription' className='mb-1.5 block text-[28px] leading-none text-[#333333]'>
              ...
              <div>
                <label htmlFor='validFor' className='mb-1.5 block text-[28px] leading-none text-[#333333]'>
                  Valid For
                </label>
                <input
                  id='validFor'
              ...
              <div>
                <label htmlFor='includedItems' className='mb-1.5 block text-[28px] leading-none text-[#333333]'>
                  What’s include
                </label>
                <textarea
                  id='includedItems'
              ...
              <div>
                <label htmlFor='subscriptionPrice' className='mb-1.5 block text-[28px] leading-none text-[#333333]'>
                  Price
                </label>
                <input
              ...
              <button
                type='button'
                className='rounded-lg bg-[#9eb39d] px-5 py-2.5 text-[30px] leading-none text-[#4f6350]'
              >
                Add Packages
              </button>
            </form>
