  ...
  return (
    <main className='flex min-h-screen items-center justify-center bg-[#f7f3ec] px-4 py-10 font-raleway text-[#0c0c0c] sm:px-6 lg:px-8'>
      ...
      >
        ...
        <h1 className='mt-6 font-playfair text-3xl text-[#171411] sm:text-4xl'>Payment Successful</h1>
        <p className='mx-auto mt-4 max-w-xl text-sm leading-7 text-[#5e564b] sm:text-base'>
          Your subscription payment was completed successfully. Your selected vendor plan is now
          active.
        </p>

        <div className='mx-auto mt-6 max-w-lg rounded-lg bg-[#f5f1ea] px-4 py-3 text-left'>
          <p className='text-xs uppercase tracking-wider text-[#7d7468]'>Transaction Reference</p>
          <p className='mt-1 break-all text-sm font-medium text-[#332d26]'>{transactionRef}</p>
        </div>
