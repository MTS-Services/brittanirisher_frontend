...
const Layout = () => {
  ...
  return (
    <div className='flex h-dvh overflow-hidden bg-[#FDFCFB]'>
      <div
      ...
      <aside
        ...
        className={`
          fixed inset-y-0 left-0 z-30 w-60 transform transition-all duration-300 ease-in-out
      ...
      <main className='flex-1 flex flex-col min-w-0 overflow-hidden'>
        <header className='lg:hidden flex items-center gap-3 h-14 px-4 bg-[#f8f8f8] border-b border-gray-200 shrink-0'>
          <button
            type='button'
